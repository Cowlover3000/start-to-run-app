...
void main() {
  testWidgets('App displays correctly with navigation', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Navigation works correctly', (WidgetTester tester) async {
    ...
    await tester.tap(
      find.text('Voortgang').last,
    ); // Use .last to avoid ambiguity
  ...
  testWidgets('Start Training button switches to training tab', (
    WidgetTester tester,
  ) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const StartToRunApp());
